    ...
    >
      <div class="setting-layout">
        ...
        <main class="setting-content">
          ...
          <!-- 关于我 -->
          <section v-show="activeTab === 'about'" class="setting-panel about-panel">
            <div class="panel-heading">
              <span class="panel-icon"><ArtSvgIcon icon="ri:user-heart-line" /></span>
              <div>
                <h2>关于我</h2>
                <p>编辑网站作者介绍，并实时查看 Markdown 渲染效果</p>
              </div>
            </div>
            ...
            <ElCard class="art-card config-card markdown-card" :body-style="{ padding: '0' }">
              <div class="card-heading markdown-card-heading">
                <div>
                  <h3>{{ aboutMode === 'edit' ? '编辑内容' : '预览效果' }}</h3>
                  <p>
                    {{
                      aboutMode === 'edit'
                        ? '使用 Markdown 编写网站作者介绍、创作方向和个人经历'
                        : '以下内容按网站前台的 Markdown 规则渲染'
                    }}
                  </p>
                </div>
                <div class="markdown-heading-actions">
                  ...
                  <div class="markdown-mode-switch" role="tablist" aria-label="关于我编辑模式">
                    <button
                      type="button"
                      role="tab"
              ...
              <div class="card-body markdown-card-body">
                <ElFormItem prop="about" class="markdown-form-item !mb-0">
                  <div v-show="aboutMode === 'edit'" class="markdown-editor">
                  ...
                  <div v-show="aboutMode === 'preview'" class="markdown-preview markdown-body">
                    <div
                  ...
                  <div v-show="aboutMode === 'edit'" class="markdown-help">
...
- 生活记录`;
  ...
  const aboutPreviewHtml = computed(() => markdown.render(form.about ?? ''));
